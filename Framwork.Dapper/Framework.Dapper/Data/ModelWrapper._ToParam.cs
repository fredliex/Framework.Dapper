...
#pragma warning restore 618
        ...
        internal static object WrapParam(object param, CommandType commandType, string sql)
        {
            ...
            var paramInfoGenerator = CreateParamInfoGenerator(param.GetType(), commandType, sql, false);
            var models = param as IEnumerable;
            if (models != null && !(param is string || param is IEnumerable<KeyValuePair<string, object>>)) return new EnumerableParamWrapper(models, paramInfoGenerator);
            return new ParamWrapper { Model = param, ParamInfoGenerator = paramInfoGenerator };
        }
