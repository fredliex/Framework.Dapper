...
namespace Framework.Data
{
    ...
    /// <para>當類別實作IDataModel時，公開(public)的成員(Property與Field)會自動Mapping。若公開成員要取消對應或是非公開(nonpublic)的成員要加入對應時，可用<see cref="ColumnAttribute">ColumnAttribute</see>來控制。</para>
    /// </remarks>
